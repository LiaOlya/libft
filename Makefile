...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/10/29 13:20:28 by oltkache          #+#    #+#              #
#    Updated: 2017/10/29 13:20:28 by oltkache         ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a

SRC = ft_isspace.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	...
	ft_strtrim.c ft_tolower.c ft_toupper.c ft_numofwords.c ft_newwords.c

OBJ = ft_isspace.o ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
	...
	ft_memcpy.o ft_memdel.o ft_memmove.o ft_memset.o ft_putchar_fd.o \
	ft_putchar.o ft_putendl_fd.o ft_putendl.o ft_putnbr_fd.o ft_putnbr.o \
	...
	ft_strtrim.o ft_tolower.o ft_toupper.o ft_numofwords.o ft_newwords.o
